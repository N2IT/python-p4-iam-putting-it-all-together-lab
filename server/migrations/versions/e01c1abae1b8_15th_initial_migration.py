"""15th initial migration

Revision ID: e01c1abae1b8
Revises: 
Create Date: 2024-05-03 10:46:59.471867
...
def upgrade():
    ...
    sa.CheckConstraint('length(instructions) > 50', name='ck_instructions_length'),
